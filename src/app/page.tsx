          ...
          <section className="relative w-full overflow-hidden bg-[#FAF7F6]">
            ...
            <div className="absolute inset-0 z-0">
              <picture className="w-full h-full block">
                <source media="(max-width: 1023px)" srcSet="/gastro-bg-4.png" />
                <img
                  src="/gastro-bg-3.png"
            ...
            {/* Gradient Overlays */}
            <div className="hidden lg:block absolute inset-0 z-0 pointer-events-none bg-gradient-to-r from-[#FAF7F6] via-[#FAF7F6]/85 to-transparent lg:max-w-[65%]"></div>
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-margin-mobile lg:px-margin-desktop pt-8 pb-72 lg:py-28 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-8 flex flex-col gap-stack-lg max-w-2xl mx-auto lg:mx-0 items-center text-center lg:items-start lg:text-left">
                ...
                {/* Hero Badges */}
                <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2.5 sm:gap-3 lg:mt-4 lg:pt-6 border-t border-surface-variant/40 w-full">
        ...
        <div className="max-w-container-max mx-auto px-margin-mobile lg:px-margin-desktop">
          ...
          <div className="mt-16 pt-8 border-t border-surface-variant/40 text-center flex flex-col items-center gap-2">
            <p className="font-label-sm text-xs text-on-surface-variant">
              © Gastrointensivismo | Powered by MedCof • CNPJ: 67.058.614/0001-03. Todos os direitos reservados.
            </p>
