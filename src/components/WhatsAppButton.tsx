...
export function WhatsAppButton({
  ...
  return (
    <aside aria-label="Suporte via WhatsApp" className="fixed bottom-6 right-6 z-40 flex items-center group">
      {/* Tooltip Hover no Desktop */}
      <span className="hidden sm:inline-flex items-center mr-3 px-3.5 py-1.5 rounded-full bg-white/95 backdrop-blur-md text-[#1A1C1C] text-xs font-semibold shadow-lg border border-[#E5DCDB] opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none translate-x-2 group-hover:translate-x-0">
